...
const NEVA_SP111_09_CONFIG = {
    modelId: 'neva_sp111_09',
    name: 'Нева СП 111 (суточный журнал 0x09)',
    manufacturer: 'Нева',
    description: 'Суточный журнал 0x09. Поддерживает объекты 3-22. Все показания типа UINT32. Полный набор тарифов T0-T4 для всех типов энергии.',
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = NEVA_SP111_09_CONFIG;
}