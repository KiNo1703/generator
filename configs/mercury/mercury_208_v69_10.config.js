// Файл: mercury_208_v69_10.config.js
// Суточный журнал показаний (Журнал 0x10)
// Модель: Меркурий 208 V69
// minObjectId = 2, maxObjectId = 21
// Все показания типа UINT32
// Полный набор тарифов T1-T4 для всех типов энергии

const MERCURY_208_V69_10_CONFIG = {
    modelId: 'mercury_208_v69_10',
    name: 'Меркурий 208 V69 (суточный журнал 0x10)',
    manufacturer: 'Меркурий',
    description: 'Суточный журнал 0x10. Поддерживает объекты 2-21. Все показания типа UINT32. Полный набор тарифов T1-T4 для всех типов энергии.',
