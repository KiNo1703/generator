...
const NEVA_MT115_04_CONFIG = {
    modelId: 'neva_mt115_04',
    name: 'Нева МТ-115 (суточный журнал 0x04)',
    manufacturer: 'Нева',
    description: 'Суточный журнал 0x04. Поддерживает объекты 3-22. Все показания типа UINT32. Полный набор тарифов T0-T4 для всех типов энергии.',
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = NEVA_MT115_04_CONFIG;
}